...
let index =0 
const [video, setVideo] = useState([videolist[index]])
  ...
  return (
    <section className="videoSection">
      ...
      <svg onClick={()=> { index += 1}} xmlns="http://www.w3.org/2000/svg" width="65" height="65" fill="red" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
